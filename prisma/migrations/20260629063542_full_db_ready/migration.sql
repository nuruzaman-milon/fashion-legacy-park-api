...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('SYSTEM', 'ORDER', 'PAYMENT', 'PROMOTION');
...
CREATE TABLE "Coupon" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "applyWithFlashSale" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Setting" (
    ...
    "currency" TEXT,
    "currencySymbol" TEXT,
    "insideDhakaShippingCharge" DECIMAL(10,2),
    "outsideDhakaShippingCharge" DECIMAL(10,2),
    "freeShippingMinimumAmount" DECIMAL(10,2),
